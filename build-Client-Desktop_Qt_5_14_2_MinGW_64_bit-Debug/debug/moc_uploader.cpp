...
QT_MOC_LITERAL(4, 23, 9), // "uploadPDU"
QT_MOC_LITERAL(5, 33, 4), // "PDU*"
QT_MOC_LITERAL(6, 38, 3), // "pdu"
QT_MOC_LITERAL(7, 42, 8), // "finished"
QT_MOC_LITERAL(8, 51, 10) // "uploadFile"

    },
    "Uploader\0errorMsg\0\0msg\0uploadPDU\0PDU*\0"
    "pdu\0finished\0uploadFile"
};
...
void Uploader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Uploader::errorMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Uploader::errorMsg(const QString & _t1)
{
